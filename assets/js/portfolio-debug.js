...
window.__cylCfg = {
  ...
  sensitivity: 0.08, friction: 0.854, frictionMobile: 0.952, maxVel: 75, smoothR: 80, shrinkDelay: 50,
...
(function () {
  ...
  const DEFAULTS = {
    ...
    sensitivity: 0.09, friction: 0.93, frictionMobile: 0.952, maxVel: 80, smoothR: 3, shrinkDelay: 60,
    crossSpeed: 0.40, crossSmooth: 82,
    speed0: 1.00, speed1: 0.85, speed2: 0.70,
    sceneTiltX: 0, sceneTiltY: 0, sceneSkewX: 0, cylAxis: 0, bowlStrength: 0,
  ...
  const sections = [
    ...
    },
    {
      ...
      rows: [
        ...
        { id: 'frictionMobile', label: 'Friction Mobile', tip: 'Тертя на мобілці — окреме значення для тач-скролу. Зазвичай вище ніж десктопне, бо тач-інерція вже є рідна.', min: 0.80, max: 0.999, step: 0.001, fmt: v => v.toFixed(3), unit: '' },
